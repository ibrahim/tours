...
module Tour.Object.Activity exposing (booked_through, confirmation, currency, day, duration, ends_at, notes, price, provider, section_id, snippets, starts_at, title, type_, uuid)
...
ends_at : SelectionSet (Maybe Float) Tour.Object.Activity
ends_at =
