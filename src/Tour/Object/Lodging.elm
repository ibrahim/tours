...
module Tour.Object.Lodging exposing (booked_through, confirmation, currency, day, duration, notes, price, provider, section_id, snippets, starts_at, title, type_, uuid)
