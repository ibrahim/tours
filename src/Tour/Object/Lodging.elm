...
module Tour.Object.Lodging exposing (booked_through, confirmation, currency, day, duration, ends_at, notes, price, provider, section_id, snippets, starts_at, title, type_, uuid)
...
booked_through : SelectionSet (Maybe String) Tour.Object.Lodging
booked_through =
    Object.selectionForField "(Maybe String)" "booked_through" [] (Decode.string |> Decode.nullable)


confirmation : SelectionSet (Maybe String) Tour.Object.Lodging
confirmation =
...
ends_at : SelectionSet (Maybe Float) Tour.Object.Lodging
ends_at =
...
provider : SelectionSet (Maybe String) Tour.Object.Lodging
provider =
    Object.selectionForField "(Maybe String)" "provider" [] (Decode.string |> Decode.nullable)


section_id : SelectionSet String Tour.Object.Lodging
section_id =
...
starts_at : SelectionSet (Maybe Float) Tour.Object.Lodging
starts_at =
    Object.selectionForField "(Maybe Float)" "starts_at" [] (Decode.float |> Decode.nullable)


title : SelectionSet (Maybe String) Tour.Object.Lodging
title =
