...
module Tour.Object.Dining exposing (currency, day, duration, notes, price, snippets, starts_at, title, type_, uuid)
...
type_ : SelectionSet (Maybe String) Tour.Object.Dining
type_ =
...
starts_at : SelectionSet (Maybe String) Tour.Object.Dining
starts_at =
    Object.selectionForField "(Maybe String)" "starts_at" [] (Decode.string |> Decode.nullable)


title : SelectionSet String Tour.Object.Dining
title =
